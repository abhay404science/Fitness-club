...
if ($new_pass != $rep_pass) {
    ...
    if ($old_pass == $orig_pass) {
        ...
        session_destroy();
        // header('location: AdminLogin.php?error=Password Updated Successfully');
        echo'<script>alert("password updated sucessfully");window.location.href="AdminLogin.php"</script>';
    } else{
        header('location: AdminSetting.php?error=Wrong Old Password.');
    }
