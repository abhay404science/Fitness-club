...
if (isset($_GET['id'])) {
   ...
   $sql = "SELECT id,heading, caption, Ylink FROM about  WHERE id = $id";
    ...
    echo "No results found.";
            ...
            ?>
              ...
              <div class="card-header">
                ...
                <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="aboutEdit_script.php" enctype = "multipart/form-data">
                ...
                <!---- -->
                    ...
                    <div class="form-group ">
                    <label for="exampleInputPassword1">Heading</label><input id="name" type="text" name="name" class="form-control" required="required" placeholder="Heading" value="<?php 
                  $sql = "SELECT id,heading, caption, Ylink FROM about  WHERE id = $id";
                    $result = $con->query($sql);
                    ...
                    <div class="form-group">
                    <label for="exampleInputPassword1">Youtube Embeded Link</label><input id="name" type="text" name="link" class="form-control" required="required" placeholder="Youtube Link" value="<?php 
                  $sql = "SELECT id,heading, caption, Ylink FROM about  WHERE id = $id";
                    $result = $con->query($sql);
                    ...
                    <div class="form-group">
                    <label for="exampleInputPassword1">Caption</label><textarea id = "message" name="description" id="description"  class="form-control" rows="7" placeholder="Enter The Description here" require=required><?php 
                  $sql = "SELECT id,heading, caption, Ylink FROM about  WHERE id = $id";
                    $result = $con->query($sql);
...
<div class="card-footer" style="margin-bottom:-2px;width: 840px;;margin-left: 9px">
<div style="">
