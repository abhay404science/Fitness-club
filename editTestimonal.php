...
if (isset($_GET['id'])) {
   ...
   $sql = "SELECT * FROM testimon  WHERE id = $id";
    ...
    echo "No results found.";
            ...
            ?>
              ...
              <div class="card-header">
                ...
                <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="editTestimonal_script.php" enctype = "multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                <div class="form-group ">
                    <input id="id" type = "hidden" name="id" class="form-control" required="required" placeholder="id" value="<?php 
                    $sql = "SELECT id,user_name,photo,caption FROM testimon  WHERE id = $id";
                    $result = $con->query($sql);
