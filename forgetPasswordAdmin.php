...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form role="form" action="forgetPassword_script.php" method="POST">
        <div class="input-group mb-3">
          <input type="email" id="fullname" name = "email" class="form-control" placeholder="Email"/>
        ...
        <div><b class="red" style="color:red">
                        <?php
                        if(isset($_GET["error"])){
                          echo $_GET['error'];
                        }
