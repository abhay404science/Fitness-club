...
if (isset($_GET['id'])) {
   ...
   $sql = "SELECT id,img,title,description FROM service  WHERE id = $id";
    ...
    echo "No results found.";
            ...
            ?>
              ...
              <div class="card-header">
                ...
                <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="serviceEdit_script.php" enctype = "multipart/form-data">
                <div class="card-body">
